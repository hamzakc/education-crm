defmodule Mix.Tasks.TeacherComponent.Setup do
  use Mix.Task

  @shortdoc "Creates an Mnesia DB on disk for Teacher Component"

  @moduledoc """
  Creates an Mnesia DB on disk for Teacher Component
  ...
  @doc false
  def run(_) do
    TeacherComponent.DefaultImpl.TeacherStore.Mnesia.setup!
  end
end
