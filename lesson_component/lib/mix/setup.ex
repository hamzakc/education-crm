defmodule Mix.Tasks.LessonComponent.Setup do
  use Mix.Task

  @shortdoc "Creates an Mnesia DB on disk for Lesson Component"

  @moduledoc """
  Creates an Mnesia DB on disk for Lesson Component
