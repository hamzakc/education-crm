defmodule ChildComponent.DefaultImpl.ChildStore.Mnesia do
  use ChildComponent.DefaultImpl.ChildStore

  @config [db: DB, table: Children]
  ...
  @doc false
  defdelegate children(teacher_id), to: @store, as: :children_with_teacher
end
