defmodule ClassComponent.DefaultImpl.ClassStore.Mnesia do
	use ClassComponent.DefaultImpl.ClassStore

  @config [db: DB, table: Classes]
  ...
  @doc "Returns the Mnesia configuration for Class Component"
  ...
  @doc false
  defdelegate find(class_id),          to: @store,   as: :find_class
end
